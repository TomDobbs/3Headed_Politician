...
remove_list = ['tonight', 'yesterday', 'today', 'tomorrow','morning', 'thank you', 'thanks', \
               ...
               'Clinton :', 'HillaryClinton', 'BernieSanders', 'Sanders :',
               '(APPLAUSE)', '(LAUGHTER)', '(CHEERS, APPLAUSE)',\
               'interview', 'congrats', 'i will be']
...
def make_substitutions(line, ignore_ascii=1):
    ...
    # isrealToken = 'b835b521c29f399c78124c4b59341691'
    ...
    # line = re.sub('Isreal', isrealToken, line)
    # line = re.sub('isreal', isrealToken, line)
