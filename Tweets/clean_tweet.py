...
depending on whether the tweet was shorter than twitter's
limit of 140 characters, or longer than the limit, in which
case the tweet ends with "(cont) http://some.link."
'''
...
# This is a list of all the users tagged by Bernie Sanders
