...
key_not_found_list = []
key_not_found_list.append("I'm sick and tired of getting confidential spam emails from Hillary!")
key_not_found_list.append("For many, the American dream has become really lame.")
key_not_found_list.append("I'm not a Democrat, I'm an Independent, and I have a bigger caucus than Trump. #girthers")
key_not_found_list.append("You know, let me be very clear. I supported Barack Obama originally; Homies since Day 1.")
key_not_found_list.append("My God...if you want to run for president, you're going to need a gazillion dollars.")

key_not_found_list2 = []
key_not_found_list2.append("Congress regulates Wall Street like I regulate the volume of my voice")
key_not_found_list2.append("Education should be a right, not a privilege. We need to revolutionize the right to play beer pong. House rules. Congress sucks.")
key_not_found_list2.append("The decision about abortion must remain a decision for the woman, her family and baby jesus to make.")
key_not_found_list2.append("We have a government of, by, and for billionaires.")
key_not_found_list2.append("If you're in the 1%, you're not in the majority.")
